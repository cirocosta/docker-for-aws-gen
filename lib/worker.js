...
class Worker {
  ...
  create () {
    ...
    this._modifyInstanceNameInUserData();
    this._setCustomTags();
  ...
  // .Parameters.WorkerDiskType --> .Parameters.[Name]WorkerDiskType
  _copyDiskType () {
    let diskType = objectExtend(
      {},this._template.Parameters.WorkerDiskType);

    this._template.Parameters[`${this._opts.Name}WorkerDiskType`] = diskType;
  }

  // .Parameters.WorkerDiskSize --> .Parameters.[Name]WorkerDiskSize
  _copyDiskSize () {
    let diskSize = objectExtend(
      {},this._template.Parameters.WorkerDiskSize);

    this._template.Parameters[`${this._opts.Name}WorkerDiskSize`] = diskSize;
  }
  ...
  _modifyInstanceNameInUserData () {
    const target = "INSTANCE_NAME='NodeAsg'";
    const replace = `INSTANCE_NAME='${this._autoScalingGroupName}'`;
